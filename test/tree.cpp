...
mettle::suite<> tree("tree", [](auto& _) {
        ...
        _.test("equal", []() {
                polysync::tree equal = polysync::tree::create({
                        polysync::tree::create({
                                { "start_time", std::uint16_t { 1 } },
                                { "scanner_count", std::uint32_t { 2 } }
                                })
                        });

                polysync::tree truth = polysync::tree::create({
                        polysync::tree::create({
                                { "start_time", std::uint16_t { 1 } },
                                { "scanner_count", std::uint32_t { 2 } }
                                })
        ...
        _.test("notequal", []() {
                polysync::tree notequal = polysync::tree::create({
                        polysync::tree::create({
                                { "start_time", std::uint16_t { 1 } },
        ...
        _.test("tooshort", []() {
                polysync::tree tooshort = polysync::tree::create({
                        polysync::tree::create({
                                { "start_time", std::uint16_t { 1 } },
                                })
                        });
        ...
        _.test("toolong", []() {
                polysync::tree toolong = polysync::tree::create({
                        polysync::tree::create({
                                { "start_time", std::uint16_t { 1 } },
                                { "scanner_count", std::uint32_t { 2 } },
